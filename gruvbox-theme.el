...
(defcustom gruvbox-variant 'dark
...
(autothemer-deftheme
   ...
   ((((class color) (min-colors #xFFFFFF) (background dark))        ; col 1 GUI/24bit dark
     ((class color) (min-colors #xFF) (background dark))            ; col 2 Xterm/256 dark
     ((class color) (min-colors #xFFFFFF) (background light))       ; col 3 GUI/24bit light
     ((class color) (min-colors #xFF) (background light)))          ; col 4 Xterm/256 light

    (gruvbox-dark0_hard      "#1d2021" "#1c1c1c" "#ffffc8" "#ffffd7")
    (gruvbox-dark0           "#282828" "#262626" "#fdf4c1" "#ffffaf")
    (gruvbox-dark0_soft      "#32302f" "#303030" "#f4e8ba" "#ffffaf")
    ...
    (gruvbox-gray            "#928374" "#8a8a8a" "#928374" "#8a8a8a")

    (gruvbox-light0_hard     "#ffffc8" "#ffffd7" "#1d2021" "#1c1c1c")
    (gruvbox-light0          "#fdf4c1" "#ffffaf" "#282828" "#262626")
    (gruvbox-light0_soft     "#f4e8ba" "#ffffaf" "#32302f" "#303030")
    ...
    (gruvbox-bright_red      "#fb4933" "#d75f5f" "#9d0006" "#870000")
    ...
    (gruvbox-neutral_red     "#fb4934" "#d75f5f" "#fb4934" "#d75f5f")
    (gruvbox-neutral_green   "#b8bb26" "#afaf00" "#b8bb26" "#afaf00")
    (gruvbox-neutral_yellow  "#fabd2f" "#ffaf00" "#fabd2f" "#ffaf00")
    (gruvbox-neutral_blue    "#83a598" "#87afaf" "#83a598" "#87afaf")
    (gruvbox-neutral_purple  "#d3869b" "#d787af" "#d3869b" "#d787af")
    (gruvbox-neutral_aqua    "#8ec07c" "#87af87" "#8ec07c" "#87af87")
    (gruvbox-neutral_orange  "#fe8019" "#ff8700" "#fe8019" "#ff8700")

    (gruvbox-faded_red       "#9d0006" "#870000" "#fb4933" "#d75f5f")
    ...
    (gruvbox-dark_blue       "#2B3C44" "#000087""#2B3C44" "#000087")
    ...
    (gruvbox-sienna          "#DD6F48" "#d7875f" "#DD6F48" "#d7875f")
    (gruvbox-darkslategray4  "#528B8B" "#5f8787" "#528B8B" "#5f8787")
    (gruvbox-lightblue4      "#66999D" "#5fafaf" "#66999D" "#5fafaf")
    (gruvbox-burlywood4      "#BBAA97" "#afaf87" "#BBAA97" "#afaf87")
    (gruvbox-aquamarine4     "#83A598" "#87af87" "#83A598" "#87af87")
    (gruvbox-turquoise4      "#61ACBB" "#5fafaf" "#61ACBB" "#5fafaf")

    (gruvbox-bg (pcase (list gruvbox-contrast gruvbox-variant)

                  (`(hard   light) gruvbox-light0_hard)
                  (`(medium light) gruvbox-light0)
                  (`(soft   light) gruvbox-light0_soft)

                  (`(hard   dark)  gruvbox-dark0_hard)
                  (`(medium dark)  gruvbox-dark0)
                  (`(soft   dark)  gruvbox-dark0_soft)))

    (gruvbox-fg (cl-case gruvbox-variant
                  (light gruvbox-dark0)
                  (dark  gruvbox-light0))))

   ;; UI
   ((default                                   (:background gruvbox-bg :foreground gruvbox-fg))
