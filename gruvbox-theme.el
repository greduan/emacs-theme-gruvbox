...
(autothemer-deftheme
 ...
 ((((class color) (background dark) (min-colors #xFFFFFF))  ; 1: GUI/24bit dark
  ...
  (gruvbox-dark0_soft      "#32302f" "#f4e8ba" "#303030" "#ffffaf")
  (gruvbox-dark1           "#3c3836" "#ebdbb2" "#3a3a3a" "#ffdfaf")
  (gruvbox-dark2           "#504945" "#d5c4a1" "#4e4e4e" "#bcbcbc")
  (gruvbox-dark3           "#665c54" "#bdae93" "#626262" "#a8a8a8")
  (gruvbox-dark4           "#7c6f64" "#a89984" "#767676" "#949494")

  (gruvbox-gray            "#928374" "#928374" "#8a8a8a" "#8a8a8a" )

  (gruvbox-light0_hard     "#ffffc8" "#1d2021" "#ffffd7" "#1c1c1c")
  (gruvbox-light0          "#fdf4c1" "#282828" "#ffffaf" "#262626")
  (gruvbox-light0_soft     "#f4e8ba" "#32302f" "#ffffaf" "#303030")
  (gruvbox-light1          "#ebdbb2" "#3c3836" "#ffdfaf" "#3a3a3a")
  (gruvbox-light2          "#d5c4a1" "#504945" "#bcbcbc" "#4e4e4e")
  (gruvbox-light3          "#bdae93" "#665c54" "#a8a8a8" "#626262")
  (gruvbox-light4          "#a89984" "#7c6f64" "#949494" "#767676")

  (gruvbox-bright_red      "#fb4933" "#9d0006" "#d75f5f" "#870000")
  (gruvbox-bright_green    "#b8bb26" "#79740e" "#afaf00" "#878700")
  (gruvbox-bright_yellow   "#fabd2f" "#b57614" "#ffaf00" "#af8700")
  (gruvbox-bright_blue     "#83a598" "#076678" "#87afaf" "#005f87")
  (gruvbox-bright_purple   "#d3869b" "#8f3f71" "#d787af" "#875f87")
  (gruvbox-bright_aqua     "#8ec07c" "#427b58" "#87af87" "#5f8787")
  (gruvbox-bright_orange   "#fe8019" "#af3a03" "#ff8700" "#af5f00")

  (gruvbox-neutral_red     "#fb4934" "#fb4934" "#d75f5f" "#d75f5f")
  (gruvbox-neutral_green   "#b8bb26" "#b8bb26" "#afaf00" "#afaf00")
  (gruvbox-neutral_yellow  "#fabd2f" "#fabd2f" "#ffaf00" "#ffaf00")
  (gruvbox-neutral_blue    "#83a598" "#83a598" "#87afaf" "#87afaf")
  (gruvbox-neutral_purple  "#d3869b" "#d3869b" "#d787af" "#d787af")
  (gruvbox-neutral_aqua    "#8ec07c" "#8ec07c" "#87af87" "#87af87")
  (gruvbox-neutral_orange  "#fe8019" "#fe8019" "#ff8700" "#ff8700")

  (gruvbox-faded_red       "#9d0006" "#fb4933" "#870000" "#d75f5f")
  (gruvbox-faded_green     "#79740e" "#b8bb26" "#878700" "#afaf00")
  (gruvbox-faded_yellow    "#b57614" "#fabd2f" "#af8700" "#ffaf00")
  (gruvbox-faded_blue      "#076678" "#83a598" "#005f87" "#87afaf")
  (gruvbox-faded_purple    "#8f3f71" "#d3869b" "#875f87" "#d787af")
  (gruvbox-faded_aqua      "#427b58" "#8ec07c" "#5f8787" "#87af87")
  (gruvbox-faded_orange    "#af3a03" "#fe8019" "#af5f00" "#ff8700")

  (gruvbox-dark_red        "#421E1E" "#421E1E" "#5f0000" "#5f0000")
  (gruvbox-dark_blue       "#2B3C44" "#2B3C44" "#000087" "#000087")
  (gruvbox-dark_aqua       "#36473A" "#36473A" "#005f5f" "#005f5f")

  (gruvbox-delimiter-one   "#458588" "#458588" "#008787" "#008787")
  (gruvbox-delimiter-two   "#b16286" "#b16286" "#d75f87" "#d75f87")
  (gruvbox-delimiter-three "#8ec07c" "#8ec07c" "#87af87" "#87af87")
  (gruvbox-delimiter-four  "#d65d0e" "#d65d0e" "#d75f00" "#d75f00")
  (gruvbox-white           "#FFFFFF" "#FFFFFF" "#FFFFFF" "#FFFFFF")
  (gruvbox-black           "#000000" "#000000" "#000000" "#000000")
  (gruvbox-sienna          "#DD6F48" "#DD6F48" "#d7875f" "#d7875f")
  (gruvbox-darkslategray4  "#528B8B" "#528B8B" "#5f8787" "#5f8787")
 ...
 ((gruvbox-dark-hard-default    (:foreground gruvbox-bg0-light :background gruvbox-bg0-dark_hard))
  ...
  (whitespace-hspace                         (:foreground gruvbox-dark4))
  (whitespace-tab                            (:foreground gruvbox-dark4))
  (whitespace-newline                        (:foreground gruvbox-dark4))
  ...
  (whitespace-space-before-tab               (:foreground gruvbox-dark4))
  (whitespace-indentation                    (:foreground gruvbox-dark4))
  (whitespace-empty                          (:background nil :foreground nil))
  (whitespace-space-after-tab                (:foreground gruvbox-dark4))
  ...
  ;; Smerge
  (smerge-mine                               (:background gruvbox-dark_aqua))
  (smerge-other                              (:background gruvbox-dark_blue))
  (smerge-markers                            (:background gruvbox-dark0_soft))
  (smerge-refined-added                      (:background gruvbox-dark_aqua))
  (smerge-refined-removed                    (:background gruvbox-dark_red))
  ...
  (popup-scroll-bar-background-face          (:background gruvbox-dark1))
  (popup-scroll-bar-foreground-face          (:background gruvbox-dark2))
  ...
  ;; powerline
  (powerline-active1                         (:background gruvbox-dark2 :foreground gruvbox-light1))
  (powerline-active2                         (:background gruvbox-dark1 :foreground gruvbox-light1))
  (powerline-inactive1                       (:background gruvbox-dark2 :foreground gruvbox-light1))
  (powerline-inactive2                       (:background gruvbox-dark1 :foreground gruvbox-light1))

  ;; spaceline
  (spaceline-evil-normal                     (:background gruvbox-bright_blue :foreground gruvbox-dark0))
  (spaceline-evil-insert                     (:background gruvbox-bright_yellow :foreground gruvbox-dark0))
  (spaceline-evil-visual                     (:background gruvbox-bright_purple :foreground gruvbox-dark0))
  (spaceline-evil-motion                     (:background gruvbox-bright_green :foreground gruvbox-dark0))
  (spaceline-evil-replace                    (:background gruvbox-bright_orange :foreground gruvbox-dark0))
  (spaceline-evil-emacs                      (:background gruvbox-bright_red :foreground gruvbox-dark0))

  ;; column-marker)
  (column-marker-1                           (:background gruvbox-faded_blue))
  (column-marker-2                           (:background gruvbox-faded_purple))
  (column-marker-3                           (:background gruvbox-faded_orange))

  ;; vline)
  (vline                                     (:background gruvbox-dark_aqua))
  (vline-visual                              (:background gruvbox-dark_aqua))

  ;; col-highlight)
  (col-highlight                             (:inherit 'vline))

  ;; column-enforce-mode)
  (column-enforce-face                       (:foreground gruvbox-light4 :background gruvbox-dark_red))

  ;; evil-quick-scope-mode
  (evil-qs-forward-primary                   (:foreground gruvbox-bright_green))
  (evil-qs-forward-secondary                 (:foreground gruvbox-bright_blue))
  (evil-qs-backward-primary                  (:foreground gruvbox-bright_green))
  (evil-qs-backward-secondary                (:foreground gruvbox-bright_blue))
...
(defun gruvbox-theme--get-default-face (variant)
...
(defun gruvbox-theme-light ()
  ...
  (interactive)
  (gruvbox-theme--load "light"))

(defun gruvbox-theme-dark ()
  "Enable gruvbox-theme and use dark version."
  (interactive)
  (gruvbox-theme--load "dark"))

(defun gruvbox-select-theme (variant contrast)
  "Select gruvbox theme with VARIANT and CONTRAST."
  (interactive
   (list
    (completing-read "Gruvbox // variant: " '(dark light))
