...
(defmacro gruvbox-deftheme (name description palette &rest body)
  `(autothemer-deftheme
    ...
    ((default                                   (:background gruvbox-bg :foreground gruvbox-light1))
     ...
     (diff-refine-added                         (:background gruvbox-faded_green  :foreground gruvbox-bright_green :bold t))
     (diff-removed                              (:background 'unspecified  :foreground gruvbox-neutral_red))
     (diff-refine-removed                       (:background gruvbox-faded_red  :foreground gruvbox-bright_red :bold t))
