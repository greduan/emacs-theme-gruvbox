...
(defmacro gruvbox-deftheme (name description palette reduced-specs &rest body)
  `(autothemer-deftheme
    ...
    ((default                                   (:background gruvbox-bg :foreground gruvbox-light0))
     ...
     (magit-diff-added                          (:foreground gruvbox-neutral_green))
     ...
     (magit-diff-hunk-heading-selection         (:background gruvbox-dark2 :foreground gruvbox-neutral_orange))
     (magit-diff-lines-heading                  (:background gruvbox-faded_orange :foreground gruvbox-light0))
     (magit-diff-removed                        (:foreground gruvbox-neutral_red))
     ...
     (magit-hash                                (:foreground gruvbox-neutral_blue))
     (magit-log-author                          (:foreground gruvbox-neutral_red))
     (magit-log-date                            (:foreground gruvbox-neutral_aqua))
