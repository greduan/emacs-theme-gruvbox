...
(defmacro gruvbox-deftheme (name description palette &rest body)
  `(autothemer-deftheme
    ...
    ((default                                   (:background gruvbox-bg :foreground gruvbox-light0))
     ...
     (lui-time-stamp-face             (:foreground gruvbox-bright_blue :weight 'bold))
     ...
     (erc-header-line            (:inherit 'hightlight :background gruvbox-dark2))
     (erc-input-face             (:foreground gruvbox-bright_green))
     (erc-current-nick-face      (:foreground gruvbox-bright_green :weight 'bold))
     (erc-timestamp-face         (:foreground gruvbox-bright_blue :weight 'bold))
     ...
     (erc-my-nick-face           (:foreground gruvbox-bright_yellow :weight 'bold))
